...
const translations = {
  en: {
    ...
    'howItWorks.subtitle': 'AgentFlow leverages GitHub Actions and AI to create automated, serverless pipelines',
    'howItWorks.step1.title': 'Scheduled Trigger',
    'howItWorks.step1.description': 'GitHub Actions runs pipelines on a schedule (daily, weekly, etc.) or on-demand',
    'howItWorks.step2.title': 'Data Collection',
    'howItWorks.step2.description': 'Pipelines fetch data from APIs, websites, social media, research databases, or other sources',
    'howItWorks.step3.title': 'AI Analysis',
    'howItWorks.step3.description': 'AI models process the data to extract insights, summarize content, and identify trends',
    'howItWorks.step4.title': 'Auto-Publish',
    'howItWorks.step4.description': 'Results are automatically generated as HTML reports and published to GitHub Pages',
    'howItWorks.stackSection.title': 'The Stack',
    'howItWorks.stack.githubActions.title': 'GitHub Actions',
    'howItWorks.stack.githubActions.description': 'Free compute for running automated pipelines on schedule or on-demand',
    'howItWorks.stack.githubPages.title': 'GitHub Pages',
    'howItWorks.stack.githubPages.description': 'Free hosting for static sites - perfect for publishing automated reports',
    'howItWorks.stack.aiApis.title': 'AI APIs',
    'howItWorks.stack.aiApis.description': 'Pay-as-you-go AI processing - only pay for what you use, no infrastructure costs',
    'howItWorks.stack.astro.title': 'Astro',
    'howItWorks.stack.astro.description': 'Fast, modern web framework for building content-rich sites with minimal JavaScript',
    'howItWorks.whySection.title': 'Why AgentFlow?',
    'howItWorks.benefit.costEffective.title': 'Cost Effective',
    'howItWorks.benefit.costEffective.description': 'No servers to manage or pay for. Only pay for AI API usage.',
    'howItWorks.benefit.zeroMaintenance.title': 'Zero Maintenance',
    'howItWorks.benefit.zeroMaintenance.description': 'GitHub handles infrastructure, scaling, and deployment automatically.',
    'howItWorks.benefit.secure.title': 'Secure & Reliable',
    'howItWorks.benefit.secure.description': "Built on GitHub's infrastructure with enterprise-grade security.",
    'howItWorks.benefit.versionControlled.title': 'Version Controlled',
    'howItWorks.benefit.versionControlled.description': 'All code, data, and configurations are tracked in Git.',
  ...
  'pt-BR': {
    ...
    'howItWorks.subtitle': 'AgentFlow aproveita GitHub Actions e IA para criar pipelines automatizados e serverless',
    'howItWorks.step1.title': 'Gatilho Agendado',
    'howItWorks.step1.description': 'GitHub Actions executa pipelines em um cronograma (diário, semanal, etc.) ou sob demanda',
    'howItWorks.step2.title': 'Coleta de Dados',
    'howItWorks.step2.description': 'Pipelines coletam dados de APIs, sites, redes sociais, bases de pesquisa ou outras fontes',
    'howItWorks.step3.title': 'Análise com IA',
    'howItWorks.step3.description': 'Modelos de IA processam os dados para extrair insights, resumir conteúdo e identificar tendências',
    'howItWorks.step4.title': 'Publicação Automática',
    'howItWorks.step4.description': 'Resultados são automaticamente gerados como relatórios HTML e publicados no GitHub Pages',
    'howItWorks.stackSection.title': 'A Stack',
    'howItWorks.stack.githubActions.title': 'GitHub Actions',
    'howItWorks.stack.githubActions.description': 'Computação gratuita para executar pipelines automatizados agendados ou sob demanda',
    'howItWorks.stack.githubPages.title': 'GitHub Pages',
    'howItWorks.stack.githubPages.description': 'Hospedagem gratuita para sites estáticos - perfeito para publicar relatórios automatizados',
    'howItWorks.stack.aiApis.title': 'AI APIs',
    'howItWorks.stack.aiApis.description': 'Processamento de IA pague conforme usar - pague apenas pelo que usar, sem custos de infraestrutura',
    'howItWorks.stack.astro.title': 'Astro',
    'howItWorks.stack.astro.description': 'Framework web moderno e rápido para criar sites ricos em conteúdo com JavaScript mínimo',
    'howItWorks.whySection.title': 'Por Que AgentFlow?',
    'howItWorks.benefit.costEffective.title': 'Custo-Efetivo',
    'howItWorks.benefit.costEffective.description': 'Sem servidores para gerenciar ou pagar. Pague apenas pelo uso da API de IA.',
    'howItWorks.benefit.zeroMaintenance.title': 'Zero Manutenção',
    'howItWorks.benefit.zeroMaintenance.description': 'GitHub cuida da infraestrutura, escalabilidade e implantação automaticamente.',
    'howItWorks.benefit.secure.title': 'Seguro e Confiável',
    'howItWorks.benefit.secure.description': 'Construído na infraestrutura do GitHub com segurança de nível empresarial.',
    'howItWorks.benefit.versionControlled.title': 'Controle de Versão',
    'howItWorks.benefit.versionControlled.description': 'Todo código, dados e configurações são rastreados no Git.',
